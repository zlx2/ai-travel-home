...
.moment-row[draggable=true]{cursor:grab}.moment-row.dragging{opacity:.55}.moment-row.fixed{cursor:default}.moment-row[draggable=true]:hover{box-shadow:inset 3px 0 0 #2563eb}
</style>
