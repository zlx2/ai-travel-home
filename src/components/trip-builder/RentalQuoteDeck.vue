...
defineProps<{ quotes:RentalQuote[]; selectedId:string; loading?:boolean; pickupText?:string }>()
...
<template>
  <section class="quote-section">
    <div class="section-title-row">
      <div>
        <h2>推荐租车方案</h2>
        <p>{{ pickupText || '根据路线、人数和预算，为你匹配 3 种出行方案。' }}</p>
      </div>
      <span>以上报价包含基础保险、手续费及税费</span>
    </div>
    <div v-if="loading" class="quote-loading builder-card">正在匹配附近服务点和租车套餐...</div>
