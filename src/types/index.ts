...
export interface Activity { time:string; title:string; description:string; tags:string[]; cost:number; costText?:string; suggestedDuration?:string; suggestedDurationSource?:string; transportSuggestion?:string; reason?:string; area?:string; address?:string; lng?:number; lat?:number; openingHours?:string; rating?:number; averageCost?:number; businessArea?:string; imageUrls?:string[]; type?:string }
