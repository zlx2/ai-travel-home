...
export interface Activity { time:string; title:string; description:string; tags:string[]; cost:number; costText?:string; suggestedDuration?:string; suggestedDurationSource?:string; transportSuggestion?:string; reason?:string; area?:string; address?:string; city?:string; lng?:number; lat?:number; openingHours?:string; rating?:number; averageCost?:number; businessArea?:string; imageUrls?:string[]; type?:string }
...
export interface TripDay { day:number; title:string; city?:string; activities:Activity[]; food:string[]; budget:number; estimatedCost?:DayEstimatedCost; intensity?:string; accommodation?:string; diningArea?:string; routeSummary?:string; tips?:string[] }
